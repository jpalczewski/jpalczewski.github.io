import{c as l,s as p,r,m as c}from"./_astro_assets.0dbbc1e3.js";import{u as i}from"./ProjectList.7a1f4a10.js";import"./index.7db25182.js";/* empty css                          */const t={};function E(n){return n.replaceAll(/__ASTRO_IMAGE_="([^"]+)"/gm,(o,s)=>p({src:t[s].src,...t[s].attributes}))}const a=E(`<p>To speed up <del>shitpost</del> sharing knowledge, I had a thought - could I leverage snippets for this purpose? Answer is: <em>yes, of course</em>.</p>
...
</section>`),d={title:"Using vscode snippets to template Astro posts",language:"en",date:"2023-08-20T21:31:57-02:00",tags:["astro","vscode","markdown"],urlsDescription:"Related URLs",referencedUrls:[{description:"General idea of using snippets to generate markdown",url:"https://dev.to/ceceliacreates/use-vs-code-snippets-to-generate-markdown-front-matter-fpc"},{description:"Time variables in snippets",url:"https://mattferderer.com/create-a-snippet-or-shortcut-in-vs-code-to-insert-the-current-date-time"}]},y="/home/runner/work/entuzjazm/entuzjazm/src/content/insight/en/post-4.md",f=void 0;function C(){return`
...
`}function b(){return a}function B(){return[{depth:2,slug:"footnote-label",text:"Footnotes"}]}const R=l((n,o,s)=>{const{layout:h,...e}=d;return e.file=y,e.url=f,r`${c()}${i(a)}`});export{R as Content,b as compiledContent,R as default,y as file,d as frontmatter,B as getHeadings,t as images,C as rawContent,f as url};
