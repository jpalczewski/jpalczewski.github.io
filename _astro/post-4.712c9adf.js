import{c as l,s as p,r,m as c}from"./_astro_assets.e9bf66b2.js";import{u as i}from"./ProjectList.a087b438.js";import"./astro-assets-services.9646dcd1.js";import"./index.7db25182.js";/* empty css                          */const E=async function(){return{}};async function d(e){return E().then(s=>e.replaceAll(/__ASTRO_IMAGE_="([^"]+)"/gm,(o,n)=>p({src:s[n].src,...s[n].attributes})))}const a=await d(`<p>To speed up <del>shitpost</del> sharing knowledge, I had a thought - could I leverage snippets for this purpose? Answer is: <em>yes, of course</em>.</p>
