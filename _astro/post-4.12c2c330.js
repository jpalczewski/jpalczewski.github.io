const e="en/post-4.md",t="insight",n="en/post-4",s=`
...
`,o={title:"Using vscode snippets to template Astro posts",tags:["astro","vscode","markdown"],language:"en",date:new Date(1692574317e3),referencedUrls:[{description:"General idea of using snippets to generate markdown",url:"https://dev.to/ceceliacreates/use-vs-code-snippets-to-generate-markdown-front-matter-fpc"},{description:"Time variables in snippets",url:"https://mattferderer.com/create-a-snippet-or-shortcut-in-vs-code-to-insert-the-current-date-time"}],urlsDescription:"Related URLs"},i={type:"content",filePath:"/home/runner/work/entuzjazm/entuzjazm/src/content/insight/en/post-4.md",rawData:`
...
referencedUrls:
  ...
  - description: "Time variables in snippets"
    url: "https://mattferderer.com/create-a-snippet-or-shortcut-in-vs-code-to-insert-the-current-date-time"`};export{i as _internal,s as body,t as collection,o as data,e as id,n as slug};
