import { c as createAstro, a as createComponent, r as renderComponent, b as renderTemplate, m as maybeRenderHead, e as renderSlot } from './astro-server-D50-taHx.js';
import 'piccolore';
import { $ as $$ThoughtsLayout } from './ThoughtsLayout-SancOJ0n.js';
import { $ as $$Breadcrumbs } from './Breadcrumbs-C-H-AML9.js';
import { P as Pagination, a as PostMeta } from './PostMeta-DqA4Leb6.js';
import { c as attr, e as escape_html } from './_at-astro-renderers-DylNdryL.js';
/* empty css                         */
...
const $$ThoughtsPaginatedPage = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "ThoughtsLayout", $$ThoughtsLayout, { "title": siteTitle, "description": siteDescription, "locale": locale, "noindex": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="unified-card"> <div class="unified-card__header"> <h1 class="unified-card__title">${pageTitle}</h1> <p class="unified-card__subtitle">${pageSubtitle}</p> </div> <div class="unified-card__divider"></div> <div class="unified-card__section"> ${renderComponent($$result2, "Breadcrumbs", $$Breadcrumbs, { "items": breadcrumbs })} <!-- Content slot - różna treść dla różnych stron --> ${renderSlot($$result2, $$slots["default"])} ${totalPages > 1 && renderTemplate`${renderComponent($$result2, "Pagination", Pagination, { "currentPage": currentPage, "totalPages": totalPages, "baseUrl": baseUrl, "prevLabel": prevLabel, "nextLabel": nextLabel, "client:load": true, "client:component-hydration": "load", "client:component-path": "@components/thoughts/Pagination.svelte", "client:component-export": "default" })}`} </div> </div> ` })}`;
