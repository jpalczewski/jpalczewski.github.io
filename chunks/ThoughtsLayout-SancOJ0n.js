...
import { g as getCollection, j as getPostsForLocale, B as getUniqueYears, C as getUniqueYearMonths } from './content-E3HRhPnq.js';
...
const $$ThoughtsLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { title, description, locale, showMonthly = true, structuredData, ogType, ogImage, article, alternates, noindex } = Astro2.props;
