import { c as attr, e as escape_html, a as ensure_array_like } from './_at-astro-renderers-DzRu7pEN.js';
/* empty css                         */
import { T as TagBadge } from './TagBadge-CUarnKLc.js';
...
function Pagination($$renderer, $$props) {
	...
	let prevUrl = currentPage > 1 ? buildPageUrl(currentPage - 1) : null;
	let nextUrl = currentPage < totalPages ? buildPageUrl(currentPage + 1) : null;
