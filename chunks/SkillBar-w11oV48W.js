import { e as escape_html, c as attr, d as attr_style, s as stringify, a as ensure_array_like } from './_at-astro-renderers-DylNdryL.js';
/* empty css                         */
...
function SkillBar($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		if (description) {
			$$renderer.push(`<!--[0--><p class="skill-bar__description svelte-11xmizc">${escape_html(description)}</p>`);
		} else {
			$$renderer.push('<!--[-1-->');
		}
		...
		if (subcategories.length > 0) {
			$$renderer.push(`<!--[0--><div class="skill-bar__subcategories svelte-11xmizc"><!--[-->`);
